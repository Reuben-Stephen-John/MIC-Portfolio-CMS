    ...
    <section id='events'>
        <div className='events-container'>
            ...
            <div className="events-list">
                {eventList.map((ele,index) => <EventCard key={index} title={ele.event_name} link={ele.registration_link} date={ele.date} time={ele.time_start} fee={ele.fee} venue={ele.venue} img={ele.cover_photo} desc={ele.description}/>)}
            </div>
        </div>
    </section>
  )
    ...
    return(
        <div className='event-card' ref={cardRef} >
            {isExpanded?(<div className="extended-card">
                ...
                <div className='extended-img'><img src={`https://uumsoqotclyqmloyiflh.supabase.co/storage/v1/object/public/Events/${img}`} alt=""/></div>
                <div className='extended-content'>
                    <div className="extended-title"><span>{title}</span></div>
                    <div className="extended-mobile-img"><img src={`https://uumsoqotclyqmloyiflh.supabase.co/storage/v1/object/public/Events/${img}`} alt=""/></div>
            ...
            <div className="event-img-small">
                <img src={`https://uumsoqotclyqmloyiflh.supabase.co/storage/v1/object/public/Events/${img}`}/>
            </div>
